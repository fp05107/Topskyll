...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const categories: InsertJobCategory[] = [
      ...
      { name: "Data Science", description: "Analytics, Visualization", icon: "fas fa-chart-line", slug: "data-science", color: "from-green-500 to-teal-500" },
      ...
      { name: "Blockchain & Web3", description: "Smart Contracts, DeFi", icon: "fab fa-bitcoin", slug: "blockchain-web3", color: "from-yellow-500 to-orange-500" },
      { name: "UI/UX Design", description: "Figma, Adobe XD", icon: "fas fa-palette", slug: "ui-ux-design", color: "from-pink-500 to-rose-500" },
      { name: "DevOps & CI/CD", description: "Docker, Kubernetes", icon: "fas fa-cogs", slug: "devops-cicd", color: "from-emerald-500 to-green-500" },
      { name: "Robotic Process Automation", description: "UiPath, Blue Prism", icon: "fas fa-robot", slug: "rpa", color: "from-violet-500 to-purple-500" },
      { name: "AR & VR", description: "Unity, Unreal Engine", icon: "fas fa-vr-cardboard", slug: "ar-vr", color: "from-cyan-500 to-blue-500" },
      { name: "SQL & Database Management", description: "MySQL, PostgreSQL, MongoDB", icon: "fas fa-database", slug: "database", color: "from-slate-500 to-gray-500" },
      { name: "Network & Systems Administration", description: "Linux, Windows Server", icon: "fas fa-network-wired", slug: "network-systems", color: "from-lime-500 to-green-500" },
      { name: "SAP & Microsoft Dynamics", description: "ERP Systems", icon: "fas fa-chart-bar", slug: "sap-dynamics", color: "from-orange-500 to-red-500" },
      { name: "Project Management", description: "Agile, Scrum, PMP", icon: "fas fa-tasks", slug: "project-management", color: "from-teal-500 to-cyan-500" },
      ...
      { name: "Digital Marketing", description: "SEO, SEM, Social Media", icon: "fas fa-bullhorn", slug: "digital-marketing", color: "from-rose-500 to-pink-500" },
      { name: "Sales & Marketing", description: "B2B Sales, Lead Generation", icon: "fas fa-handshake", slug: "sales-marketing", color: "from-indigo-500 to-purple-500" },
      { name: "Accounts (Digital)", description: "Digital Finance, Fintech", icon: "fas fa-calculator", slug: "digital-accounts", color: "from-emerald-500 to-teal-500" },
      { name: "IT Support & Troubleshooting", description: "Technical Support, Helpdesk", icon: "fas fa-tools", slug: "it-support", color: "from-blue-500 to-indigo-500" },
      { name: "Quality Assurance", description: "Testing, Automation", icon: "fas fa-check-circle", slug: "quality-assurance", color: "from-green-500 to-emerald-500" }
    ];
